...
export const t: Record<Lang, Strings> = {
  en: {
    ...
    aboutValues: [
      { t: "Cooked with care", d: "A slow ragù, good olive oil, and the family recipes we grew up with." },
    ...
    storyP1:
      "Al Primo Piano opened above the harbour in December 2025, under old wooden beams and the glow of a red lamp. We cook the way our family taught us — a slow ragù, good olive oil, and the Italian classics we grew up with.",
    ...
    heroSubtitle: "A family-run Italian kitchen above the harbour, with honest Italian food and a warm welcome.",
  ...
  it: {
    ...
    aboutValues: [
      { t: "Fatto con cura", d: "Un ragù lento, buon olio d'oliva e le ricette di famiglia con cui siamo cresciuti." },
    ...
    storyP1:
      "Al Primo Piano ha aperto sopra il porto nel dicembre 2025, sotto vecchie travi di legno e la luce di una lampada rossa. Cuciniamo come ci ha insegnato la famiglia — un ragù lento, buon olio d'oliva e i classici italiani con cui siamo cresciuti.",
    ...
    heroSubtitle: "Una cucina italiana a conduzione familiare sul porto, con cucina genuina e un caloroso benvenuto.",
  ...
  nl: {
    ...
    aboutValues: [
      { t: "Met zorg bereid", d: "Een langzame ragù, goede olijfolie en de familierecepten waarmee we zijn opgegroeid." },
    ...
    storyP1:
      "Al Primo Piano opende in december 2025 boven de haven, onder oude houten balken en het licht van een rode lamp. We koken zoals onze familie het ons leerde — een langzame ragù, goede olijfolie en de Italiaanse klassiekers waarmee we zijn opgegroeid.",
    ...
    heroSubtitle: "Een Italiaanse familiekeuken boven de haven, met eerlijke Italiaanse gerechten en een warm welkom.",
