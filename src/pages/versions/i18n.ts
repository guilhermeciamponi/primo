...
export const t: Record<Lang, Strings> = {
  en: {
    ...
    pressCaption2: "“If you want to taste authentic Italy, this restaurant is highly recommended.” — our new wood-fired pizzas, featured in De Stadskrant.",
    ...
    valueProps: [
      ...
      "Harbour-side in Volendam",
      "Illy coffee, Italian style",
      "Fine Italian wines",
      "A warm, rustic welcome",
    ],
    aboutValues: [
      { t: "Made by hand", d: "Fresh pasta rolled every day, a slow ragù, good olive oil." },
      { t: "From the harbour", d: "The day's catch from the boats right outside our window." },
      { t: "Like family", d: "A warm, unfussy welcome and a table you won't want to leave." },
    ],
    ...
    storyP1:
      "Al Primo Piano opened above the harbour in December 2025, under old wooden beams and the glow of a red lamp. We cook the way our family taught us — hand-rolled pasta, a slow ragù, good olive oil, and the day's catch from the boats outside the window.",
    storyP2: "Nothing fussy. Just honest Italian food, generous plates, and a table you won't want to leave.",
    storySign: "— the family",
    menuTitle: "The Menu",
    menuSub: "Antipasti & Primi — written by hand, every day",
    ...
    newsletter: "Join our table — news & specials",
    newsletterPh: "Your email",
    newsletterBtn: "Subscribe",
    closed: "Closed",
    rights: "All rights reserved",
    heroSubtitle: "A family-run Italian kitchen above the harbour — fresh pasta, the day's catch, and a warm welcome.",
  ...
  it: {
    ...
    aboutValues: [
      { t: "Fatto a mano", d: "Pasta fresca ogni giorno, un ragù lento, buon olio d'oliva." },
      { t: "Dal porto", d: "Il pescato del giorno dalle barche fuori dalla finestra." },
    ...
    storyP1:
      "Al Primo Piano ha aperto sopra il porto nel dicembre 2025, sotto vecchie travi di legno e la luce di una lampada rossa. Cuciniamo come ci ha insegnato la famiglia — pasta fatta a mano, un ragù lento, buon olio d'oliva e il pescato del giorno dalle barche fuori dalla finestra.",
    ...
    menuTitle: "Il Menu",
    menuSub: "Antipasti e Primi — scritto a mano, ogni giorno",
    ...
    newsletter: "Unisciti alla nostra tavola — novità e offerte",
    newsletterPh: "La tua email",
    newsletterBtn: "Iscriviti",
    closed: "Chiuso",
    rights: "Tutti i diritti riservati",
    heroSubtitle: "Una cucina italiana a conduzione familiare sul porto — pasta fresca, il pescato del giorno e un caloroso benvenuto.",
  ...
  nl: {
    ...
    aboutValues: [
      { t: "Met de hand", d: "Elke dag verse pasta, een langzame ragù, goede olijfolie." },
      { t: "Uit de haven", d: "De dagverse vangst van de boten voor ons raam." },
    ...
    storyP1:
      "Al Primo Piano opende in december 2025 boven de haven, onder oude houten balken en het licht van een rode lamp. We koken zoals onze familie het ons leerde — handgemaakte pasta, een langzame ragù, goede olijfolie en de dagverse vangst van de boten buiten.",
    ...
    menuTitle: "Het Menu",
    menuSub: "Antipasti & Primi — elke dag met de hand geschreven",
    ...
    newsletter: "Schuif aan — nieuws & specials",
    newsletterPh: "Uw e-mail",
    newsletterBtn: "Aanmelden",
    closed: "Gesloten",
    rights: "Alle rechten voorbehouden",
    heroSubtitle: "Een Italiaanse familiekeuken boven de haven — verse pasta, de vangst van de dag en een warm welkom.",
