...
export const t: Record<Lang, Strings> = {
  en: {
    ...
    noticeBody: "We count visits with two cookies of our own. They are not shared with anyone. The Contact page loads a Google map on its own, so Google receives your IP address there.",
  ...
  it: {
    ...
    noticeBody: "Contiamo le visite con due cookie nostri. Non vengono condivisi con nessuno. La pagina Contatti carica da s\u00e9 una mappa di Google, quindi Google riceve l\u00ec il suo indirizzo IP.",
  ...
  nl: {
    ...
    noticeBody: "Wij tellen bezoeken met twee eigen cookies. Ze worden met niemand gedeeld. De contactpagina laadt zelf een kaart van Google, dus Google ontvangt daar uw IP-adres.",
